...
# csv file
csvpath = os.path.join('/Users', 'joelfernandes', 'Desktop', 'PyPoll', 'Resources', 'election_data.csv')
...
with open(csvpath, newline='') as csvfile:
    ...
    for row in csvreader:
        ...
        # Calculation of khan correy and li
        if (row[2] == "Khan"):
            khan_votes += 1
        elif (row[2] == "Correy"):
            correy_votes += 1
...
# Output file answer 2
output_file = os.path.join('/Users', 'joelfernandes', 'Desktop', 'answer2')
